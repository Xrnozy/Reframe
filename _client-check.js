...
.design-section{margin-bottom:4px}.design-panel .panel-actions-divider{display:none}.design-panel .panel-metrics{display:none}.figma-rail{align-items:center;background:#1c1c1e;border-radius:12px;box-shadow:0 8px 32px rgb(0 0 0/.38),0 0 0 1px rgb(255 255 255/.08);display:flex;flex-direction:column;gap:2px;left:12px;padding:6px;pointer-events:auto;position:fixed;top:68px;z-index:2147483004}.figma-rail .button.icon{border-radius:8px;height:36px;width:36px}.figma-rail .button.icon[aria-pressed="true"]{background:rgb(124 58 237/.35);box-shadow:inset 0 0 0 1px rgb(167 139 250/.5)}.figma-rail-divider{background:rgb(255 255 255/.12);height:1px;margin:4px 2px;width:28px}.figma-sidebar{background:#1c1c1e;border:1px solid rgb(255 255 255/.08);border-radius:12px;box-shadow:0 8px 32px rgb(0 0 0/.38);color:#f5f5f7;display:flex;flex-direction:column;font:500 12px/1.35 system-ui;height:calc(100vh - 80px);max-height:calc(100vh - 80px);min-height:0;overflow:hidden;pointer-events:auto;position:fixed;top:68px;z-index:2147483003}.figma-sidebar[hidden]{display:none}.figma-sidebar-head{align-items:center;border-bottom:1px solid rgb(255 255 255/.08);color:#a1a1aa;display:flex;font:600 10px/1 system-ui;justify-content:space-between;letter-spacing:.06em;padding:10px 12px;text-transform:uppercase}.figma-sidebar-body{flex:1 1 auto;min-height:0;overflow:auto;padding:8px}.layers-panel{background:#1e1e1e;border-color:rgb(255 255 255/.06);height:auto;left:64px;max-height:calc(100vh - 100px);min-width:260px;max-width:360px;overflow:hidden;position:relative;width:min(300px,calc(100vw - 88px))}.layers-head{align-items:center;gap:6px;min-height:32px;padding:6px 8px}.layers-head-actions{align-items:center;display:inline-flex;flex-shrink:0;gap:0;margin-left:auto}.layers-head-icon-btn{border-radius:6px;color:#a1a1aa;flex-shrink:0;height:24px!important;min-width:24px!important;opacity:.85;width:24px!important}.layers-head-icon-btn svg{height:14px;width:14px}.layers-head-icon-btn:hover{background:rgb(255 255 255/.08);color:#e4e4e7;opacity:1}.layers-resize-handle{bottom:0;cursor:ew-resize;position:absolute;right:0;top:0;width:6px;z-index:2}.layers-head .layers-title{color:#f5f5f7;font:600 12px/1 system-ui;letter-spacing:0;text-transform:none}.layers-collapse-btn{flex-shrink:0;height:24px!important;min-width:24px!important;opacity:.7;width:24px!important}.layers-collapse-btn:hover{opacity:1}.layers-collapse-btn svg{height:14px;width:14px}.layers-search-wrap{border-bottom:1px solid rgb(255 255 255/.06);padding:6px 8px}.layers-search{background:#2a2a2e;border:1px solid rgb(255 255 255/.08);border-radius:8px;color:#f5f5f7;font:500 12px/1.35 system-ui;padding:6px 10px;width:100%}.layers-search::placeholder{color:#71717a}.layers-search:focus{border-color:rgb(139 92 246/.45);box-shadow:0 0 0 2px rgb(139 92 246/.12);outline:none}.layers-scroll{flex:1 1 auto;min-height:0;overflow-x:hidden;overflow-y:auto;padding:2px 0 0;scrollbar-color:rgb(255 255 255/.15) transparent;scrollbar-width:thin}.layers-scroll::-webkit-scrollbar{width:6px}.layers-scroll::-webkit-scrollbar-thumb{background:rgb(255 255 255/.15);border-radius:3px}.layers-tree{display:flex;flex-direction:column;gap:1px;padding:0 4px 2px}.layers-group{display:flex;flex-direction:column}.layers-row{align-items:center;border-radius:6px;color:#e4e4e7;cursor:pointer;display:flex;gap:4px;min-height:28px;padding:4px 8px 4px calc(6px + var(--depth,0) * 14px);position:relative;transition:background .12s}.layers-row:hover{background:rgb(255 255 255/.06)}.layers-row.selected{background:rgb(124 58 237/.18);color:#f5f5f7}.layers-row.selected::before{background:#8b5cf6;border-radius:1px;bottom:4px;content:"";left:2px;position:absolute;top:4px;width:2px}.layers-toggle{align-items:center;background:transparent;border:0;border-radius:4px;color:#71717a;cursor:pointer;display:inline-flex;flex-shrink:0;height:18px;justify-content:center;padding:0;width:18px}.layers-toggle:hover{background:rgb(255 255 255/.08);color:#d4d4d8}.layers-toggle svg{display:block;height:12px;pointer-events:none;transition:transform .15s;width:12px}.layers-toggle:not(.expanded) svg{transform:rotate(-90deg)}.layers-toggle-spacer{flex-shrink:0;width:18px}.layers-icon{align-items:center;border-radius:4px;display:inline-flex;flex-shrink:0;font:700 9px/1 system-ui;height:16px;justify-content:center;width:16px}.layers-icon-frame{background:rgb(59 130 246/.18);color:#93c5fd}.layers-icon-frame::before{content:"#";font-size:10px}.layers-icon-text{background:rgb(34 197 94/.15);color:#86efac}.layers-icon-text::before{content:"T"}.layers-icon-heading{background:rgb(168 85 247/.18);color:#d8b4fe}.layers-icon-heading::before{content:"H"}.layers-icon-image{background:rgb(244 114 182/.15);color:#f9a8d4}.layers-icon-image::before{content:"◻";font-size:8px}.layers-icon-button{background:rgb(251 191 36/.15);color:#fcd34d}.layers-icon-button::before{content:"▣";font-size:8px}.layers-icon-input{background:rgb(148 163 184/.15);color:#cbd5e1}.layers-icon-input::before{content:"In";font-size:7px;letter-spacing:-.02em}.layers-name{flex:1;font:500 12px/1.3 system-ui;min-width:0;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.layers-tag{color:#71717a;flex-shrink:0;font:500 10px/1 ui-monospace,monospace;max-width:72px;overflow:hidden;text-overflow:ellipsis;opacity:0;transition:opacity .15s;white-space:nowrap}.layers-row:hover .layers-tag,.layers-row.selected .layers-tag{opacity:1}.layers-row.selected .layers-tag{color:#a78bfa}.layers-children{border-left:1px solid rgb(255 255 255/.07);margin:0 0 0 calc(16px + var(--depth,0) * 14px);padding-left:4px}.layers-empty{color:#71717a;font:500 12px/1.4 system-ui;padding:12px;text-align:center}.design-panel{right:12px;width:min(280px,calc(100vw - 88px))}.design-panel .panel{box-shadow:none;border-radius:10px;flex-direction:column;align-items:stretch;gap:8px;max-width:100%;padding:12px;position:static;width:100%}.design-panel .edit-toolbar-section{flex-wrap:wrap;width:100%}.design-panel .panel-input[data-reframe-text]{display:block!important;width:100%}.design-position{display:grid;gap:6px;grid-template-columns:1fr 1fr;margin-bottom:8px}.design-position .layout-field{width:100%}.design-position .layout-input{width:100%}.figma-zoom{align-items:center;background:#1c1c1e;border-radius:999px;bottom:16px;box-shadow:0 8px 32px rgb(0 0 0/.38),0 0 0 1px rgb(255 255 255/.08);display:inline-flex;gap:2px;left:50%;padding:4px 6px;pointer-events:auto;position:fixed;transform:translateX(-50%);z-index:2147483004}.figma-zoom .button.icon{border-radius:8px;height:32px;min-width:32px;width:32px}.figma-zoom-label{color:#a1a1aa;font:600 11px/1 ui-monospace,monospace;min-width:44px;text-align:center}:host([data-reframe-tool="hand"]){cursor:grab}:host([data-reframe-tool="hand"][data-reframe-panning="true"]){cursor:grabbing}';
  ...
  const designSection = (title, hint, open = false) => { const section = document.createElement("details"); section.className = "design-section"; if (open) section.open = true; const summary = document.createElement("summary"); summary.textContent = title; section.append(summary); const body = document.createElement("div"); body.className = "design-section-body"; if (hint) body.append(designSectionHint(hint)); section.append(body); return { section, body }; };
  let designPadSides, designMarSides, designPadLink, designMarLink, designPadUniform, designMarUniform, designFlexControls, designEssentialText, typeSection;
  const setupLayoutLabels = () => {
    ...
    grid.className = "design-grid-4";
    for (const selector of ["[data-reframe-layout-x]", "[data-reframe-layout-y]", "[data-reframe-layout-width]", "[data-reframe-layout-height]"]) {
      const field = layoutPanel.querySelector(selector)?.closest(".layout-field");
      if (field) grid.append(field);
    }
    layoutPanel.replaceChildren(grid);
  };
  const createSpacingBlock = (title, uniformAria, sides) => {
    const block = document.createElement("div");
    block.className = "design-spacing-block design-spacing-compact";
    const row = document.createElement("div");
    row.className = "design-spacing-row";
    const headTitle = document.createElement("span");
    headTitle.className = "design-spacing-title";
    headTitle.textContent = title;
    const linkBtn = document.createElement("button");
    linkBtn.type = "button";
    linkBtn.className = "design-spacing-link button icon";
    ...
    expandBtn.className = "design-expand-sides button";
    ...
    sidesWrap.className = "design-spacing-sides";
    ...
    expandBtn.addEventListener("click", () => { sidesWrap.hidden = !sidesWrap.hidden; });
    ...
    row.append(headTitle, linkBtn, uniform.wrap, expandBtn);
    block.append(row, sidesWrap);
  ...
  const initDesignPanel = () => {
    ...
    const { section: essentialSection, body: essentialBody } = designSection("Design", null, true);
    setupLayoutLabels();
    if (layoutPanel) essentialBody.append(layoutPanel);
    essentialBody.append(designField("Fill", designFill));
    if (layoutRadius) essentialBody.append(designField("Radius", layoutRadius));
    if (textInput) { designEssentialText = designField("Text", textInput); designEssentialText.classList.add("design-essential-text"); essentialBody.append(designEssentialText); }
    const { section: layoutSection, body: layoutBody } = designSection("Layout", null, false);
    layoutBody.append(designField("Display", designDisplay));
    ...
    positionGrid.className = "design-grid-2";
    positionGrid.append(designField("Top", designTop.wrap), designField("Right", designRight.wrap), designField("Bottom", designBottom.wrap), designField("Left", designLeft.wrap));
    layoutBody.append(designField("Position", designPosition), positionGrid, designField("Z-index", designZ), designField("Overflow", designOverflow), designField("Min W", designMinW.wrap), designField("Max W", designMaxW.wrap), designField("Min H", designMinH.wrap), designField("Max H", designMaxH.wrap), designField("Opacity", designOpacity), designField("Border", designBorderWidth), designField("Border color", designBorderColor), designField("Bg image", designBgImage), designField("Outline", designOutline));
    ...
    effectsBody.classList.add("design-grid-2");
    effectsBody.append(designField("Shadow X", designShadowX), designField("Shadow Y", designShadowY), designField("Blur", designShadowBlur), designField("Shadow color", designShadowColor), designField("Filter blur", designBlur), designField("Move X", designTranslateX), designField("Move Y", designTranslateY));
    ...
    const { section: actionSection, body: actionBody } = designSection("Actions", null, true);
    for (const node of [metrics, apply, cancel, mapping, hint, impactBtn, overlapBtn, temporary].filter(Boolean)) actionBody.append(node);
    panel.replaceChildren(essentialSection, layoutSection, typeSection, effectsSection, actionSection);
  ...
  const defaultImageDimensions = (naturalWidth, naturalHeight) => {
    const maxWidth = Math.min(IMAGE_DEFAULT_MAX_WIDTH, innerWidth * 0.4);
  ...
  const imagePlacement = (stored, naturalWidth, naturalHeight, anchorX, anchorY) => {
    const dims = stored?.width && stored?.height ? { width: stored.width, height: stored.height } : defaultImageDimensions(naturalWidth, naturalHeight);
    const x = stored?.x ?? Math.max(8, Math.min(innerWidth - dims.width - 8, (anchorX ?? innerWidth / 2) - dims.width / 2));
    const y = stored?.y ?? Math.max(56, Math.min(innerHeight - dims.height - 8, (anchorY ?? innerHeight / 2) - dims.height / 2));
  ...
  const LAYOUT_STYLE_KEYS = ["border-radius", "transform", "background-color", "background-image", "opacity", "border-width", "border-color", "border-style", "box-shadow", "outline", "display", "flex-direction", "justify-content", "align-items", "gap", "padding-top", "padding-right", "padding-bottom", "padding-left", "margin-top", "margin-right", "margin-bottom", "margin-left", "position", "top", "right", "bottom", "left", "z-index", "overflow", "min-width", "max-width", "min-height", "max-height", "filter"];
  ...
  const syncDesignPanel = () => {
    ...
    if (typeSection) typeSection.open = showText;
  };
  ...
  const toggleLayersPanel = () => { layersPanelVisible = !layersPanelVisible; syncToolUi(); };
  ...
  const createLayerRow = (element, depth) => {
    const row = document.createElement("div");
    row.className = "layers-row" + (active?.element === element ? " selected" : "");
  ...
  const renderLayersTree = () => {
    ...
    const appendNodes = (parent, container, depth) => {
      for (const child of layerChildren(parent)) {
        ...
        if (rect.width <= 0 && rect.height <= 0 && !kids.length) continue;
  ...
  const applyCanvasZoom = () => {
    // ponytail: scale html; fixed overlay host shares the same containing block
    if (canvasZoom === 1) { document.documentElement.style.transform = ""; document.documentElement.style.transformOrigin = ""; }
    else { document.documentElement.style.transformOrigin = "0 0"; document.documentElement.style.transform = "scale(" + canvasZoom + ")"; }
    syncToolUi();
    scheduleGeometry();
    scheduleAnnotations();
  };
  ...
  const renderAnnoints = () => { if (!annointSvg) return; annointSvg.replaceChildren(); syncAnnointLayer(); if (!annotationsVisible) return; for (const stroke of annointDraft.strokes) { if (stroke.tool === "circle" && stroke.cx !== undefined) { const circle = document.createElementNS("http://www.w3.org/2000/svg", "circle"); circle.setAttribute("cx", String(stroke.cx)); circle.setAttribute("cy", String(stroke.cy)); circle.setAttribute("r", String(stroke.r || 24)); circle.setAttribute("stroke", stroke.color || "#f59e0b"); circle.setAttribute("stroke-width", String(stroke.width || 2)); circle.setAttribute("fill", "none"); annointSvg.append(circle); } else if (stroke.points?.length) { const path = document.createElementNS("http://www.w3.org/2000/svg", "path"); path.setAttribute("d", "M" + stroke.points.map(([x, y]) => x + " " + y).join(" L")); path.setAttribute("stroke", stroke.color || "#f59e0b"); path.setAttribute("stroke-width", String(stroke.width || 2)); path.setAttribute("fill", "none"); annointSvg.append(path); } } for (const node of annointDraft.texts) { const text = document.createElementNS("http://www.w3.org/2000/svg", "text"); text.setAttribute("x", String(node.x)); text.setAttribute("y", String(node.y)); text.setAttribute("fill", node.color || "#f5f5f7"); text.setAttribute("font-size", String(node.fontSize || 16)); text.textContent = node.text; annointSvg.append(text); } };
  ...
  const exitCommentMode = () => { if (!commentMode) return; commentMode = false; commentPointer = undefined; annointPointer = undefined; selectedImageId = undefined; endCommentPointerTracking(); endImageDrag(); if (commentModeToggle) { commentModeToggle.setAttribute("aria-pressed", "false"); commentModeToggle.setAttribute("aria-label", "Comment mode"); } if (commentTools) commentTools.hidden = true; if (activeTool === "comment") activeTool = "select"; selectMode = activeTool === "select" || activeTool === "text"; syncAnnointLayer(); syncToolUi(); };
  const enterCommentMode = () => { if (commentMode) return; commentMode = true; activeTool = "comment"; if (selectMode) { selectMode = false; hideHover(); } if (active) void flushAutosave().then(() => clearSelection("Comment mode — selection cleared", false)); if (commentModeToggle) { commentModeToggle.setAttribute("aria-pressed", "true"); commentModeToggle.setAttribute("aria-label", "Exit comment mode"); } if (commentTools) commentTools.hidden = false; commentHistory = [commentSnapshot()]; commentHistoryIndex = 0; syncCommentUndoButtons(); syncAnnointLayer(); syncToolUi(); void loadAnnoints(); explain("Comment mode: draw · paste image · Ctrl+Z undo"); };
  ...
  const savePastedImage = async (file) => {
    ...
    const position = imagePlacement(null, natural.width, natural.height, anchorX, anchorY);
  ...
  const renderAnnotations = () => {
    ...
    for (const annotation of annotationState.annotations) {
      ...
      if (annotation.kind === "image" && annotation.position && annotation.imagePath) {
        ...
        const stored = annotation.position;
        const width = stored.width || defaultImageDimensions().width;
        const height = stored.height || defaultImageDimensions().height;
        wrap.style.left = Math.max(0, Math.min(innerWidth - 40, stored.x)) + "px";
        wrap.style.top = Math.max(0, Math.min(innerHeight - 40, stored.y)) + "px";
  ...
  const scheduleAnnotations = () => { if (!annotationFrame) annotationFrame = requestAnimationFrame(renderAnnotations); };
  ...
  const HISTORY_LANE_COLORS = ["#f97316", "#3b82f6", "#22c55e"];
  const HISTORY_LANE_X = [14, 28, 42];
  ...
  const assignHistoryLanes = (checkpoints, currentId) => {
    ...
    for (const checkpoint of checkpoints) {
      ...
      lanes.set(checkpoint.id, parentLane === 0 ? 1 : parentLane < 2 ? parentLane + 1 : 2);
    }
    return lanes;
  };
  ...
  const renderHistoryList = () => {
    ...
    const layout = checkpoints.map((checkpoint, index) => {
      ...
      return { checkpoint, lane, index, x: HISTORY_LANE_X[lane], y: index * HISTORY_ROW_H + 25 };
    });
    ...
    for (const node of layout) {
      ...
      if (checkpoint.route) {
        ...
        routePill.style.setProperty("--pill-bg", "rgb(" + (node.lane === 0 ? "249 115 22" : node.lane === 1 ? "59 130 246" : "34 197 94") + " / .18)");
        routePill.style.setProperty("--pill-fg", HISTORY_LANE_COLORS[node.lane] || HISTORY_LANE_COLORS[0]);
  ...
  const chooseElement = (element) => {
    ...
    explain("Selected " + labelFor(element));
    updateGeometry();
  };
  ...
  const onDesignFillInput = () => { if (!active) return; setPreviewStyle("background-color", designFill.value); };
  ...
  const onLayoutWidthInput = () => { if (!active || !layoutWidth) return; previewWidth(Number(layoutWidth.value)); cacheDraft(); };
  const onLayoutHeightInput = () => { if (!active || !layoutHeight) return; previewHeight(Number(layoutHeight.value)); cacheDraft(); };
  const onLayoutRadiusInput = () => { if (!active || !layoutRadius) return; setPreviewStyle("border-radius", Math.max(0, Math.min(999, Math.round(Number(layoutRadius.value) || 0))) + "px"); };
  ...
  const teardown = () => {
    ...
    document.removeEventListener("pointermove", onChromePointerMove, true);
    ...
    removeEventListener("resize", requestHistory);
  ...
  const imagePosition = (id) => { const item = annotationState.annotations.find((entry) => entry.id === id); return item?.position ? { ...item.position } : null; };
  ...
  const resizeImagePosition = (start, handle, dx, dy, lockAspect) => {
    ...
    if (handle.includes("e")) width = Math.max(IMAGE_MIN_SIZE, start.width + dx);
    if (handle.includes("w")) { width = Math.max(IMAGE_MIN_SIZE, start.width - dx); x = start.x + start.width - width; }
    if (handle.includes("s")) height = Math.max(IMAGE_MIN_SIZE, start.height + dy);
    if (handle.includes("n")) { height = Math.max(IMAGE_MIN_SIZE, start.height - dy); y = start.y + start.height - height; }
    if (lockAspect) {
      if (handle === "e" || handle === "w") height = Math.max(IMAGE_MIN_SIZE, Math.round(width / ratio));
      else if (handle === "n" || handle === "s") width = Math.max(IMAGE_MIN_SIZE, Math.round(height * ratio));
      else if (handle.includes("e")) height = Math.max(IMAGE_MIN_SIZE, Math.round(width / ratio));
      else height = Math.max(IMAGE_MIN_SIZE, Math.round(width / ratio));
  ...
  const onImagePointerMove = (event) => {
    ...
    if (imageDrag.mode === "move") {
      setImagePosition(imageDrag.id, { ...imageDrag.startPosition, x: imageDrag.startPosition.x + dx, y: imageDrag.startPosition.y + dy, width: imageDrag.startPosition.width, height: imageDrag.startPosition.height });
    } else {
  ...
  const onCommentPointerMove = (event) => {
    ...
    if (commentPointer.tool === "pen") commentPointer.points.push([event.clientX, event.clientY]);
    else { const cdx = event.clientX - commentPointer.start[0]; const cdy = event.clientY - commentPointer.start[1]; commentPointer.r = Math.max(8, Math.hypot(cdx, cdy)); commentPointer.cx = commentPointer.start[0]; commentPointer.cy = commentPointer.start[1]; }
    renderAnnoints();
    if (commentPointer.tool === "pen") {
      const path = document.createElementNS("http://www.w3.org/2000/svg", "path");
      path.setAttribute("d", "M" + commentPointer.points.map(([x, y]) => x + " " + y).join(" L"));
      path.setAttribute("stroke", commentPointer.color);
      path.setAttribute("stroke-width", String(commentPointer.width));
      path.setAttribute("fill", "none");
      annointSvg?.append(path);
    }
  };
  const onCommentPointerUp = (event) => {
    ...
    if (commentPointer.moved) {
      if (commentPointer.tool === "circle") annointDraft.strokes.push({ tool: "circle", color: commentPointer.color, width: commentPointer.width, cx: commentPointer.cx, cy: commentPointer.cy, r: commentPointer.r });
      else annointDraft.strokes.push({ tool: "pen", color: commentPointer.color, width: commentPointer.width, points: commentPointer.points });
      pushCommentHistory();
      void saveAnnoints();
  ...
  const onCommentPointerDown = (event) => {
    ...
    if (event.altKey) {
      ...
      if (text) { annointDraft.texts.push({ x: event.clientX, y: event.clientY, text, color: "#f5f5f7", fontSize: 16 }); renderAnnoints(); pushCommentHistory(); void saveAnnoints(); }
      return;
    }
    event.preventDefault();
    commentPointer = { pointerId: event.pointerId, x: event.clientX, y: event.clientY, moved: false, tool: event.shiftKey ? "circle" : "pen", color: "#f59e0b", width: 2, points: [[event.clientX, event.clientY]], start: [event.clientX, event.clientY] };
  ...
  layersSearch?.addEventListener("input", () => { layersSearchQuery = layersSearch.value; renderLayersTree(); });
  ...
  document.addEventListener("pointermove", (event) => { lastPointer = { x: event.clientX, y: event.clientY }; onChromePointerMove(event); }, true);
  ...
  addEventListener("resize", requestHistory);
  addEventListener("scroll", scheduleAnnotations, true);
  addEventListener("resize", scheduleAnnotations);
  addEventListener("resize", () => { renderHeatmap(); scheduleGeometry(); });
