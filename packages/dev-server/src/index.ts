...
export { createSourceEditor, injectReactViteSourceMetadata, injectVanillaSourceMetadata, promotedClassName, resolveProjectPath, type EditPlan, type EditResult, type MappingCandidate, type MappingConfidence, type MappingResult, type SourceEditorOptions, type StylingMode, type TransactionOperations, type WidthEditRequest } from "./source-editor.js";
export { fingerprintHash } from "@reframe/shared";
export { createHistoryStore, readOnlyGitSpawnOptions, type CheckpointInput, type CheckpointMetadata, type CheckpointSummary, type GitSnapshot, type HistoryFileInput, type HistoryPreflight, type HistoryState, type HistoryStoreOptions, type ScreenshotCapture, type ScreenshotRecord, type ScreenshotStage } from "./history.js";
